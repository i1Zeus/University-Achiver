                ...
                <form wire:submit.prevent="add">
                    <div class="py-8 space-y-4 text-base leading-6 text-gray-700 sm:text-lg sm:leading-7">
                        ...
                        <div class="md:col-span-2">
                            <label for="city"> نوع الحدث </label>
                            <select name="" wire:model.lazy="state" id="rent" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-7 ">
